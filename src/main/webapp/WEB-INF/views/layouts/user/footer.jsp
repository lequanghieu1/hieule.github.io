...
<section class="our_client">
	...
	<div class="row">
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/aaaa.png"/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/aaa.png"/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/bbb.png"/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/ccc.png"/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/ddd.png"/>"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/eee.png"/>"></a>
		</div>
	</div>
</section>
